...
ontobdc_help_dev() {
  ...
  CONTENT="${CONTENT}    \033[36mbranch-create <name>\033[0m                \033[90mAlias for: branch --create <name>\033[0m\n"
  CONTENT="${CONTENT}    \033[36mchangelog [ref]\033[0m                     \033[90mAlias for: branch --changelog [ref]\033[0m\n"
