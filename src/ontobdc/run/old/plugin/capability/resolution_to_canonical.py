...
class ResolutionToCanonicalCapability(TransformationCapability):
    ...
    def _load_spacy_model(self, lang: str) -> Any:
        try:
            ...
            raise ImportError("spaCy is required for intent parsing. Install with 'pip install spacy' and download a model with 'python -m spacy download en_core_web_sm' or 'python -m spacy download pt_core_news_sm'.")
