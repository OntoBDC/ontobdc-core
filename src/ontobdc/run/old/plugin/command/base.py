...
from ontobdc.shared.domain.port.logger import LoggerAwarePort, LogLevelPort
from ontobdc.shared.domain.port.machine import StateTransitionHandlerPort, StatechartRepositoryPort
...
class RunBaseCommand(CliCommandPort, LoggerAwarePort, PromptChoiceAwarePort, PromptRawTextAwarePort):
    ...
    def run(self) -> CommandResponse:
        ...
        try:
            ...
            # current_state_code: str = current_state.value.strip('__')
