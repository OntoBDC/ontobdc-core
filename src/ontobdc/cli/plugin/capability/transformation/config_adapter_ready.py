...
class ConfigAdapterReadyCapability(TransactionCapability):
    METADATA = CapabilityMetadata(
        ...
        log_message={
            "info": {
                "en": (
                    "Configuration bootstrap file was created or validated and is "
                    "ready for CLI initialization."
                ),
            },
            "debug_entry": {
                "en": (
                    "Creating or validating the CLI bootstrap configuration file "
                    "so the shared ConfigDataAdapter can be used downstream."
                ),
            },
        },
    )
